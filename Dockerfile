...
FROM hexpm/elixir:1.14.3-erlang-24.3.4.9-debian-bullseye-20230202-slim AS build
...
FROM hexpm/elixir:1.14.3-erlang-24.3.4.9-debian-bullseye-20230202-slim
...
ENV OBAN_ADMIN_IP 0.0.0.0

# copy release to app container
COPY --from=build /app/_build/prod/rel/oban_admin .
COPY entrypoint.sh .
