defmodule ObanAdmin.Schemas.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ObanAdmin.Repo)
  ...
  """
  def valid_password?(%ObanAdmin.Schemas.User{hashed_password: hashed_password}, password)
