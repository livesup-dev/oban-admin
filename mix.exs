defmodule ObanAdmin.MixProject do
  ...
  def private_deps() do
    palette_dep(File.exists?("../palette")) ++ ex_services_dep(File.exists?("../ex-services"))
  end
  ...
  def ex_services_dep(true = _local) do
    [{:ex_services, path: "../ex-services"}]
  end

  def ex_services_dep(false) do
    [
      {:ex_services, git: "https://github.com/equinixmetal/ex-services", tag: "0.1.26"}
    ]
  end
